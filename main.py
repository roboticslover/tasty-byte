...
st.markdown("""
             TastyByte is an app that generates restaurant names and menu items based on the selected cuisine. 
             Select a food genre from the dropdown menu and click the "Generate Recommendation" button to get started!
             """)
